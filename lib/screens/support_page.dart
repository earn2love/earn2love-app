    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Card(
            child: Padding(
              ...
              child: Column(
                ...
                children: const [
                  Text("Safety & Help", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 16)),
                  SizedBox(height: 8),
                  Text("• Report abuse → we review\n• After 3 reports → 24hrs freeze (Phase 2)\n• Help center & rules will be added"),
                ],
              ),
            ),
          ),
          ...
          const Text("Quick FAQs (Phase 1)", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900)),
          const SizedBox(height: 8),
          const Text("Q: Coins not updating?\nA: Check internet + reload. WalletHistory shows changes."),
          const SizedBox(height: 8),
          const Text("Q: Permission denied?\nA: Firestore Rules must allow your UID access."),
        ],
      ),
    );
  }
